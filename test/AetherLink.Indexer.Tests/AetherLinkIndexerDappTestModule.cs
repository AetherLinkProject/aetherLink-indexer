...
[DependsOn(
    typeof(AetherLinkIndexerOrleansTestBaseModule),
...
public class AetherLinkIndexerDappTestModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.Configure<IndexSettingOptions>(options =>
        {
            ...
            options.IndexPrefix = "AetherLinkIndexer";
        });
    ...
    {
        var types = GetTypesAssignableFrom<IIndexBuild>(typeof(AetherLinkIndexerModule).Assembly);
